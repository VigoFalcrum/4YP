...
def train_classifier():
    ...
    clf = DecisionTreeClassifier(max_depth=max_depth_param, min_samples_split=min_split_param)
...
if __name__ == '__main__':
    if "--train" in sys.argv:
        ...
        subprocess.run([sys.executable, sys.argv[0], "--train", sys.argv[1], sys.argv[2]])
