...
def test_classifier():
    # This branch expects sys.argv to be: [script, "--test", n_estimators, max_depth, min_samples_split, n_jobs]
    if len(sys.argv) < 6:
    ...
    # Open the classifier
    filename = f"XGBoost_{n_estimators_param}_{max_depth_param}.pkl"
