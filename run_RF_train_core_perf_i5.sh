...
n_estimators=(5 5 5 15 15 15 45 45 45 90 90 90 140 140 140 200 200 200)
max_depths=(7 15 25 7 15 25 7 15 25 7 15 25 7 15 25 7 15 25)
min_samples_split=(150 20 2 100 10 2 50 5 2 25 2 2 15 2 2 10 2 2)
...
for core in "${core_counts[@]}"; do    
    ...
    for (( i=0; i<num_configs; i++ )); do
        ...
        # Extract instructions and cycles, removing all non-digit characters.
        instructions=$(echo "$perf_output" | grep "instructions" | head -n1 | awk '{print $1}' | tr -cd '0-9')
        cycles=$(echo "$perf_output" | grep "cycles" | head -n1 | awk '{print $1}' | tr -cd '0-9')
