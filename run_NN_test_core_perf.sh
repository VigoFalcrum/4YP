...
depths=(2 3 5 7 9 2 3 5 7 9 2 3 5 7 9 2 3 5 7 9 2 3 5 7 9 2 3 5 7 9 2 3 5 7 9 2 3 5 7 9 2 3 5 7 9)
hidden_sizes=(4 4 4 4 4 8 8 8 8 8 16 16 16 16 16 32 32 32 32 32 64 64 64 64 64 128 128 128 128 128 256 256 256 256 256 512 512 512 512 512 1024 1024 1024 1024 1024)

# Define the core counts to test.
core_counts=(32)

# Overall results file for summary.
overall_results="NN_testing_perf_results.txt"
> "$overall_results"
...
for core in "${core_counts[@]}"; do    
    ...
    for (( i=0; i<num_configs; i++ )); do
        ...
        perf_output=$(OMP_NUM_THREADS=$core sudo -E perf stat -e cache-misses,cache-references,task-clock,instructions,cycles \
            python3 NN_test_perf.py --test "$hidden_size_val" "$depth_val" "$core" 2>&1)
